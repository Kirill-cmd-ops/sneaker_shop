...
from backend.catalog_service.catalog_service.catalog.seeds.seed_countries import seed_countries
from backend.catalog_service.catalog_service.catalog.seeds.seed_colors import seed_colors
from backend.catalog_service.catalog_service.catalog.seeds.seed_sneaker_colors import seed_sneaker_colors
from backend.catalog_service.catalog_service.catalog.seeds.seed_materials import seed_materials
from backend.catalog_service.catalog_service.catalog.seeds.seed_sneaker_materials import seed_sneaker_materials
