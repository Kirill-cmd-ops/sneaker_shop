...
from microservices.auth_service.auth_service.auth.schemas.permissions import (
...
async def update_role_permissions(
    ...
    permission_names = await update_role_permissions_orchestrator(
        session=session,
        redis_client=redis_client,
        user_role=user_role,
        list_permissions=list_permissions,
    )
    return RolePermissionsResponse(role=user_role, permissions=permission_names)
